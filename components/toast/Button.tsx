  ...
  return (
    <button
      ...
      className={classNames(
        ...
        "bg-indigo-400 text-white hover:bg-indigo-500 disabled:hover:bg-primary-400 disabled:brightness-75  focus-visible:text-dark",
    ...
    >
      {isLoading && (
        <div
          className={classNames(
            "absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 text-white "
          )}
        >
          <Spinner />
        </div>
